        ...
        <div class="p-6">
            <div class="grid gap-6 lg:grid-cols-[320px,1fr]">
                ...
                <section class="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
                    <div class="bg-muted px-8 pb-10 pt-10 text-center text-foreground">
                        <Avatar
                            class="mx-auto mb-4 h-28 w-28 overflow-hidden rounded-full border-4 border-white/90 bg-white"
                        >
                            <AvatarImage v-if="user?.avatar" :src="user.avatar" :alt="fullName" />
                            <AvatarFallback class="text-2xl font-semibold text-primary">
                ...
                <section class="rounded-2xl border border-border bg-card p-6 shadow-sm">
                    ...
                    <p class="mb-5 mt-1 text-sm text-muted-foreground">
                        Basic information about your account. Most fields are read-only and synced from HRIS.
                    </p>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div class="space-y-1 text-sm">
                            ...
                            <p class="rounded-md border border-border bg-muted/40 px-3 py-2 font-medium">
                    ...
                    >
                        To update official information like office, employment status, and HR details, please use the
                        <span class="font-medium">My Details</span> section or contact the HR administrator.
                    </div>
                </section>
            </div>
        </div>
