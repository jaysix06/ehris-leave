        ...
        <template v-if="profile || personalInfo || officialInfo || contactInfo">
            <div class="ehris-official-info-grid">
                <dl class="ehris-official-info-col">
                    ...
                    <div class="ehris-details-row"><dt>Sex at birth</dt><dd>{{ val(personalInfo?.gender) }}</dd></div>
                ...
                <dl class="ehris-official-info-col">
                    ...
                    <div class="ehris-details-row"><dt>Residential — Barangay</dt><dd>{{ val(contactInfo?.barangay) }}</dd></div>
                    <div class="ehris-details-row"><dt>Residential — City/Municipality</dt><dd>{{ val(contactInfo?.city_municipality) }}</dd></div>
                    <div class="ehris-details-row"><dt>Residential — Province</dt><dd>{{ val(contactInfo?.province) }}</dd></div>
                    ...
                    <div class="ehris-details-row"><dt>Permanent — Barangay</dt><dd>{{ val(contactInfo?.barangay1) }}</dd></div>
                    <div class="ehris-details-row"><dt>Permanent — City/Municipality</dt><dd>{{ val(contactInfo?.city_municipality1) }}</dd></div>
                    <div class="ehris-details-row"><dt>Permanent — Province</dt><dd>{{ val(contactInfo?.province1) }}</dd></div>
