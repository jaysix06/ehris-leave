...
class MyDetailsController extends Controller
{
    ...
    public function exportPdsExcel(Request $request): StreamedResponse
    {
        ...
        foreach ($educationLevels as $rowNum => $levelLabel) {
            ...
            $cellMap["D{$rowNum}"] = $this->pdsValue($record->school_name ?? null);
            $cellMap["G{$rowNum}"] = $this->pdsValue($record->course ?? null);
            $cellMap["J{$rowNum}"] = $this->pdsValue($record->from_year ?? null);
            $cellMap["K{$rowNum}"] = $this->pdsValue($record->to_year ?? null);
            $cellMap["L{$rowNum}"] = $this->pdsValue($record->highest_grade ?? null);
            $cellMap["M{$rowNum}"] = $this->pdsValue($record->year_graduated ?? null);
            $cellMap["N{$rowNum}"] = $this->pdsValue($record->scholarship ?? null);
        }
