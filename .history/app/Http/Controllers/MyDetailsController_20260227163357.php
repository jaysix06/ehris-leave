...
class MyDetailsController extends Controller
{
    ...
    public function exportPdsExcel(Request $request): StreamedResponse
    {
        ...
        $cellMap = [
            ...
            'D18' => $contactInfo->subdivision_village ?? null,                      // Subdivision/Village
            'I18' => $contactInfo->residential_barangay_name ?? null,                // Barangay (name)
            'D19' => $contactInfo->city_municipality ?? null,                        // City/Municipality
            'I19' => $contactInfo->residential_province_name ?? null,                // Province (name)
            'D20' => $contactInfo->zip_code ?? null,                                 // ZIP Code
