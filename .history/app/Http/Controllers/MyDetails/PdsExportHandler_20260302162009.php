...
class PdsExportHandler
{
    ...
    private function populateTemplateWorkbook(
        ...
        if ($educationStyleMap !== null && is_file($stylesPath)) {
            ...
            if (isset($educationStyleMap['F'], $educationStyleMap['J'])) {
                $educationStyleMap['F'] = [
                    $this->cloneXfWithBorderFrom($stylesPath, $educationStyleMap['F'][0], $educationStyleMap['J'][0]),
                    $this->cloneXfWithBorderFrom($stylesPath, $educationStyleMap['F'][1], $educationStyleMap['J'][1]),
                ];
            }
        }
