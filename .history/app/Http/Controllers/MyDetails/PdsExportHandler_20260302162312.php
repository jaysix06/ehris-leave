...
class PdsExportHandler
{
    ...
    private function populateTemplateWorkbook(
        ...
        if ($educationStyleMap !== null && is_file($stylesPath)) {
            ...
            if (isset($educationStyleMap['F'], $educationStyleMap['I'])) {
                $educationStyleMap['F'] = [
                    $this->cloneXfWithBorderFrom($stylesPath, $educationStyleMap['F'][0], $educationStyleMap['I'][0]),
                    $this->cloneXfWithBorderFrom($stylesPath, $educationStyleMap['F'][1], $educationStyleMap['I'][1]),
                ];
            }
        }
