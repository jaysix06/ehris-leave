...
class PdsExportHandler
{
    ...
    private function populateTemplateWorkbook(
        ...
        if ($educationStyleMap !== null && is_file($stylesPath)) {
            if (isset($educationStyleMap['D'], $educationStyleMap['F'])) {
                $educationStyleMap['D'] = [
            ...
            if (isset($educationStyleMap['G'], $educationStyleMap['I'])) {
                $educationStyleMap['G'] = [
                    $this->cloneXfWithBorderFrom($stylesPath, $educationStyleMap['G'][0], $educationStyleMap['I'][0]),
                    $this->cloneXfWithBorderFrom($stylesPath, $educationStyleMap['G'][1], $educationStyleMap['I'][1]),
                ];
            }
        }
