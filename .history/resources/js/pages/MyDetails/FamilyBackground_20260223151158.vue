...
/* Spouse info: First name, Middle name, Occupation, Employer/Business name */
.ehris-field-row-spouse-names .ehris-field-input {
    max-width: 12rem;
}
.ehris-field-row-spouse-names .ehris-field-extension .ehris-field-input {
    max-width: 5rem;
}
/* Spouse: Business address, Telephone no. */
.ehris-field-row-spouse-contact .ehris-field-input {
    max-width: 20rem;
}
