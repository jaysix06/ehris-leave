        ...
        <template v-if="!isEditing">
            <template v-if="hasFamily">
                <div class="ehris-official-info-grid ehris-family-view-grid">
                    ...
                    <dl class="ehris-official-info-col ehris-official-info-col-mother">
...
<style scoped>
/* View mode: limit Mother's column value width; keep same box styling as other columns */
.ehris-family-view-grid .ehris-official-info-col-mother dd {
    max-width: 10rem;
}
.ehris-family-form {
    width: 100%;
